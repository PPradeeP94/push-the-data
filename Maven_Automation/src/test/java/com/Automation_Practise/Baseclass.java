...
//			}
	...
	public static void iframes(String type, WebElement element,String value,int a) {
	...
	public static String singleData(String path, int rowIndex,int columnIndex) throws IOException {
